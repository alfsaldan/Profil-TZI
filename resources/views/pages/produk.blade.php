...
.hero-bg {
            position: relative;
            background: linear-gradient(to right, rgba(10, 22, 40, 0.95) 30%, rgba(10, 22, 40, 0.4) 60%, rgba(10, 22, 40, 0.2) 100%), url(url("{{ asset('images/hero/produk
            ''
    ...
    <main class="py-20">
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-12"
                data-aos="fade-up">
                <div>
                    <h2 class="text-2xl font-black text-sky-600 b-2 uppercase">Katalog Produk Utama</h2>
